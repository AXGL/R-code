...
```{r}
salary.table <- 
  read.csv("C:/Users/Administrator.SC-201809091908/Documents/nba-players-stats/NBA_season1718_salary.csv")
ss <- read.csv("C:/Users/Administrator.SC-201809091908/Documents/nba-players-stats/Seasons_Stats.csv")
```
